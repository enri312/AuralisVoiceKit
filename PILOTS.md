...
Nota Unreleased: `tools/output_pilot.py` agrega `system_output_operator_gate.copy_readiness` para indicar si la plantilla con placeholders es segura para copiar, si faltan confirmaciones locales y si la salida real ya esta lista para auditoria beta. English: audible-output copy readiness separates safe command templates from beta-ready real playback.
