...
- Pilotos manuales con transcripcion real: runner preparado con `tools/transcription_pilot.py`; dry-run sintetico Windows aprobado, scoring redactado y guardas de duracion preparados, audio real pendiente con archivo no sensible.
