...
- campo `recommended_pilot_sequence` con el orden recomendado para pilotos reales, fixture sintetico, preflight MP3 de transcripcion, auditoria estricta y refresco del checklist beta;
...
py tools\pilot_audio_fixture.py --output-dir pilot_runs\transcription\fixture --format wav --format mp3 --json
...
python tools\pilot_audio_fixture.py --output-dir pilot_runs\transcription\fixture --format wav --format mp3 --json
