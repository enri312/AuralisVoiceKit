...
- resumen `beta_readiness`, `next_evidence_focus` y pasos `next_beta_evidence_steps` para cerrar blockers beta con metadatos de guard backend estricto cuando aplica;
