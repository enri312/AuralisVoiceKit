...
`tools/beta_readiness.py` no ejecuta hardware ni red. Lee el gate y `PILOT_FINDINGS.md`, genera `BETA_CHECKLIST.md` y marca blockers hasta que haya evidencia real de transcripcion, salida audible y pilotos Ubuntu/Linux y macOS.
...
python tools\beta_readiness.py --output BETA_CHECKLIST.md --fail-on-blockers --json
...
- Checklist de beta: preparado con `tools/beta_readiness.py`; estado actual `pilot`, beta bloqueada por pilotos reales pendientes.
