    ...
    *,
    ...
    checks = [
        ...
        _beta_gap_check(
            ...
            False,
            target_output_backend["readiness_plan"]["uses_pip_extra"],
            target_output_backend["readiness_plan"]["uses_pip_extra"] is False,
        ),
        _beta_gap_check(
            "target_output_backend.readiness_plan.python_extra",
            None,
            target_output_backend["readiness_plan"]["python_extra"],
            target_output_backend["readiness_plan"]["python_extra"] is None,
        ),
        _beta_gap_check(
            "target_output_backend.readiness_plan.pip_command",
            None,
            target_output_backend["readiness_plan"]["pip_command"],
            target_output_backend["readiness_plan"]["pip_command"] is None,
        ),
        _beta_gap_check(
...
def _build_findings_markdown(
    *,
    ...
    lines = [
        ...
        f"- Target output backend readiness pip command: {_format_nullable(target_output_backend['readiness_plan']['pip_command'])}",
...
def _system_output_dependency_plan(
    *,
    ...
    return {
        ...
        "uses_pip_extra": readiness_plan["uses_pip_extra"],
        "python_extra": readiness_plan["python_extra"],
        "pip_command": readiness_plan["pip_command"],
...
def _build_system_output_next_step_markdown(
    *,
    ...
    lines = [
        ...
        f"- Uses pip extra: {system_output_command_card['system_dependency_plan']['uses_pip_extra']}",
        f"- Python extra: {_format_nullable(system_output_command_card['system_dependency_plan']['python_extra'])}",
        f"- Pip command: {_format_nullable(system_output_command_card['system_dependency_plan']['pip_command'])}",
