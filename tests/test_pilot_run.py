...
class PilotRunTests(unittest.TestCase):
    def test_safe_pilot_writes_report_and_artifacts(self):
        ...
        self.assertIn("batch_state", persisted["release_batch"])
        self.assertIn("batch_summary_es", persisted["release_batch"])
        self.assertIn("publishable_commits_needed", persisted["release_batch"])
        self.assertIn("Mejoras desde ultimo tag", plan)
        self.assertIn("Estado del lote de release", plan)
        self.assertIn("Commits publicables faltantes", plan)
        ...
        self.assertIn("Estado del lote de release", handoff)
        self.assertIn("Commits publicables faltantes", handoff)
        self.assertIn("Crear tag ahora", handoff)
        self.assertIn("Crear tag ahora", decision_gate)
        self.assertIn("Estado del lote de release", decision_gate)
